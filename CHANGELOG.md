...
## 16/9/2021 (Halo - Version 1.0.3)
- Update Checkout Page.

## Halo 1.0.1 (2021-07-12)
- Updated Show Add To Cart when the product has variants that default to out of stock.

## Halo 1.0.1 (2021-05-31)
- Updated Variants Colors.

## Halo 1.0.1 (2021-04-20)
- Fix the Complete the Look get the price by product main
- When not enter the position of Menu Label, the mega menu has an error.
- On product detail page, the wishlist icon is skewed from the text.
- When changing option "Show Reviews?", the Editor reports error.
- In the Description tab on mobile, when you click the "show more" button and scroll elsewhere, the "show less" button will disappear.
- Recently Viewed on the mobile phone when clicking on the 2nd product, the popup product info show is on the wrong position.
- When Before You Leave has loaded the product, the producct option on Quick View popup cannot be changed.
- If the username or password is entered incorrectly on the login popup, the login page is returned and the login will not be possible.
- When clicking "Show More" on product filter sidebar, the Show More pop-up is overshadowed by the background overlay.
