...
import themevale_labelSale from '../themevale/themevale_labelSale';
    ...
    getMoreFacetResults($navList) {
        ...
        if (this.requestOptions.showMore) {
            api.getPage(facetUrl, {
                ...
                $('#modal').addClass('facetShowMore');
                $('body').addClass('facetShowMore');

                $('.modal-background').on('click', function() {
                    if ($('body').hasClass('facetShowMore')) {
                        $('body').removeClass('facetShowMore');
                    }
                });
